    ...
    $.extend($.validator, {
       ...
       // 遍历每一个input
        ...
        defaultShowError: function (value, element) {
            ...
            $.validator.methods.maxlength(value,element);
            $.validator.methods.minlength(value,element);
            $.validator.methods.email(value,element);
            $.validator.methods.url(value,element);
            $.validator.methods.phone(value,element);
            $.validator.methods.confirmPassword(value,element);
        ...
        methods: {
            ...
            confirmPassword: function (value,element) {
                var isMaccoRequired = element.attr("macco-required");
